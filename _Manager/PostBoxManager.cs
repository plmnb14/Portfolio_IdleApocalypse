//----------------------------------------------------------------------------------------------------
// 목적 : 우편 목록 로그, 파싱, 수령, 일과 처리와 UI 연동 (뒤끝 서버 API 사용)
// 
// 주요 기능
// - 우편 목록을 로그인 시 1회 갱신 후 콜백 기반 갱신(불필요한 네트워크 사용 최소화), Json 파싱
// - 관리자/랭크 보상 우편의 MetaData(만료일, 발신자, 타입 등...)과 아이템 목록 처리
// - 수령, 일괄 수령 트랜젝션, 실패/성공 단계형 진행(Queue) 및 메시지, 로딩 UI 동기화
// - 운영/라이브 필수 기능인 우편함을 안정적으로 지원하는 백엔드(우편) 연동 매니저
//----------------------------------------------------------------------------------------------------
