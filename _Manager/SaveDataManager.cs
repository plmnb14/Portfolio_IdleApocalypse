...
//
// 목적 : 유저 정장 데이터(저장, 인벤토리, 랭크 등...)을 서버 동기화 및 관리
// 
// 주요 기능
// - 뒤끝(Backend)서버와 연동해 단일 저장/로드, 트랜젝션 저장/로드 처리 
// - 자동저장/수동저장 쿨타임 제어 및 저장 예외 처리 관리
// - 다중 테이블(UserInfo, SkillInventory 등...) 동기화 지원
// - 결제, 보상 등 서버 로그 기록과 연계
// - 데이터 무결성과 안정성을 보장하는 핵심 저장 매니저
//----------------------------------------------------------------------------------------------------
...
public class SaveDataManager : Singleton<SaveDataManager>
{
    ...
    private readonly string[] dataTableNames = new string[]
        {
            // 2025-09-16 : 실시간으로 적용중인 테이블명이라 가명으로 변경
